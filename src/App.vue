<template>
  <v-app>
    <v-app-bar
      ...
      v-if="successLogInGetter === 1"
    >
      <v-toolbar-title
        ><b>{{
          organisationDetailSGetter.name_of_organisation
        }}</b></v-toolbar-title
      >
      <v-spacer></v-spacer>
      <v-tabs
      ...
      >
        ...
        <v-tab
          href="#tab-6"
          v-if="userRoleGetter['roles'] == 'adminUser'"
          style="font-size:9px;"
          @click="redirectToDashboard(6)"
        >
        ...
        <v-tab
          href="#tab-5"
          style="font-size:9px;"
          @click="redirectToDashboard(5)"
        >
          Control Visibility <v-icon>mdi-solar-panel</v-icon>
        </v-tab>

        <v-menu style="font-size:9px;" bottom left>
    ...
    <v-main
      style="background-color:rgb(247, 237, 237);"
      v-if="successLogInGetter === 1"
    >
...
export default {
  ...
  computed: {
    ...mapGetters([
      "dataGetter",
      "dataGettingStatusGetter",
      "loginStatusGetter",
      "successLogInGetter",
      "userDetailsGetter",
      "organisationDetailSGetter",
      "userRoleGetter",
    ]),
  },
  created() {},
